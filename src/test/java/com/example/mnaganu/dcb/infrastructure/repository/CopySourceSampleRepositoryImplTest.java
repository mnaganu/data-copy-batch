package com.example.mnaganu.dcb.infrastructure.repository;

import com.example.mnaganu.dcb.domain.model.SampleModel;
import com.example.mnaganu.dcb.domain.model.SelectModel;
import com.example.mnaganu.dcb.infrastructure.mapper.SampleRowMapper;
...
public class CopySourceSampleRepositoryImplTest {
    ...
    void select_検索結果0件() {
        //offset が 0よりも小さい
        SelectModel<SampleModel> selectModel = copySourceSampleRepositoryImpl.select(-1, 1);
        ...
        //limit が 1よりも小さい
        selectModel = copySourceSampleRepositoryImpl.select(0, 0);
        assertThat(selectModel.getList().isEmpty()).isTrue();
        assertThat(selectModel.getOffset()).isEqualTo(0);
        assertThat(selectModel.getLimit()).isEqualTo(0);
        assertThat(selectModel.getTotal()).isEqualTo(0);
        ...
        //offset が 0よりも小さい　
        //limit が 1よりも小さい
        selectModel = copySourceSampleRepositoryImpl.select(-1, 0);
        assertThat(selectModel.getList().isEmpty()).isTrue();
        assertThat(selectModel.getOffset()).isEqualTo(0);
        assertThat(selectModel.getLimit()).isEqualTo(0);
        assertThat(selectModel.getTotal()).isEqualTo(0);
        ...
        //テーブルを作り直してデータを全て消す。
        createTable();
        selectModel = copySourceSampleRepositoryImpl.select(1, 10);
        assertThat(selectModel.getList().isEmpty()).isTrue();
    ...
    void select_検索結果1件() {
        //先頭の1件
        SelectModel<SampleModel> selectModel = copySourceSampleRepositoryImpl.select(0, 1);
        assertThat(selectModel.getOffset()).isEqualTo(0);
        ...
        //中間の1件
        selectModel = copySourceSampleRepositoryImpl.select(1, 1);
        assertThat(selectModel.getOffset()).isEqualTo(1);
        assertThat(selectModel.getLimit()).isEqualTo(1);
        assertThat(selectModel.getTotal()).isEqualTo(3);
        ...
        //最後の1件
        selectModel = copySourceSampleRepositoryImpl.select(2, 10);
    ...
    void selectAll_検索結果が複数件() {
        SelectModel<SampleModel> selectModel = copySourceSampleRepositoryImpl.select(0, 10);
        assertThat(selectModel.getOffset()).isEqualTo(0);
        assertThat(selectModel.getLimit()).isEqualTo(10);
        assertThat(selectModel.getTotal()).isEqualTo(3);
